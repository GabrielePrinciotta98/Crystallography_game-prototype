...
public class EmitterConeSol : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        var emitterConeSolTransform = transform;
        newScale = emitterConeSolTransform.localScale;

        newScale.x = 0.4f + 0.4f / 9f * (zoom - 1f);
        newScale.z = 0.4f + 0.4f / 9f * (zoom - 1f); 
        emitterConeSolTransform.localScale = newScale;
